...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _store = __webpack_require__(327);
	  ...
	  */
	  ...
	  _createClass(Vocabulary, [{
	    ...
	    value: function wordsInput(e) {
	      ...
	      if (this.Store.readStore("vocabulary-list")) this.wordsArr = this.Store.readStore("vocabulary-list");

	      this.wordsArr.push(wordsObj);
	      //Update Store
	      this.Store.createStore("vocabulary-list", JSON.stringify(this.wordsArr));
	      if (wordsObj) this.updateHTML(wordsObj);
	      //Reset Form data once it sent
	      this.form.reset();
	    }
	  }, {
	    key: 'deleteWords',
	    value: function deleteWords(e) {
	      var loadStore = this.Store.readStore("vocabulary-list"),
	    ...
	    value: function renderHTML(elm) {
	      ...
	      if (elm && elm !== null) {
	        ...
	        elm.forEach(function (data) {
	          ...
	          //Add delete event
	          document.querySelector('#delete-word-' + data.italian).addEventListener("click", function (e) {
	            _this2.deleteWords(e);
	          });
	        });
	      }
	    }
	    ...
	    */
	    ...
	    key: 'updateHTML',
	    value: function updateHTML(htmlDATA) {
	      var _this3 = this;
	      ...
	      //Add delete event
	      document.querySelector('#delete-word-' + htmlDATA.italian).addEventListener("click", function (e) {
	        _this3.deleteWords(e);
	      });
	      location.reload();
	    }
	    ...
	    value: function startTest() {
	      ...
	      if (startBtn && this.Store.readStore("vocabulary-list").length !== 0) startBtn.style.display = "block";
	      startBtn.addEventListener("click", function (e) {
	        _this4.renderTestView();
	      });
	    }
	    /*
	    * RenderTestView
	    */
	    ...
	    key: 'renderTestView',
	    value: function renderTestView() {
	      var _this5 = this;

	      this.wordId = 0;
	      var dashbordView = document.querySelector('.dashboard'),
	      ...
	      testForm.addEventListener("submit", function (e) {
	        _this5.genarateTest(e, randomNum);
	      });
	    }
	    /*
	    * Genarate Test
	    ...
	    */
	    ...
	    key: 'genarateTest',
	    value: function genarateTest(e, randNum) {
	      if (e !== null) e.preventDefault();
	      var testView = document.querySelector('#testView'),
	      ...
	      if (this.wordId !== savedWords.length) {
	        var firstword = savedWords[randNum[this.wordId]].english,
	        ...
	        if (e !== null) this.answerHelper(savedWords[randNum[this.wordId - 1]].english, savedWords[randNum[this.wordId - 1]].italian, secondWordLabel.value, true);

	        //reset input feild
	        secondWordLabel.value = "";
	        this.wordId++;
	      } else {
	        this.answerHelper(savedWords[randNum[this.wordId - 1]].english, savedWords[randNum[this.wordId - 1]].italian, secondWordLabel.value);
	    ...
	    key: 'renderResultView',
	    value: function renderResultView() {
	      ...
	      //Genarate Score
	      var scorePres = totalCorrect / resultList.length * 100;
	    ...
	    key: 'answerHelper',
	    value: function answerHelper() {
	      for (var _len = arguments.length, answers = Array(_len), _key = 0; _key < _len; _key++) {
	      ...
	      if (this.Store.readStore("vocabulary-test")) helperArry = this.Store.readStore("vocabulary-test");
	    ...
	    */
	    ...
	    key: 'getRandomNumberHelper',
	    value: function getRandomNumberHelper(pos) {
	      var o = Array.from(new Array(pos), function (val, index) {
	        return index;
	      });
...
/***/ (function(module, exports) {
	...
	var Store = function () {
	  ...
	  */
	  ...
	  _createClass(Store, [{
	    key: "createStore",
	    value: function createStore(name, data) {
	    ...
	    */
	    ...
	    key: "updateStore",
	    value: function updateStore(storage, list, data) {
	      //Get Storage and then push the current data
	      var activeStorage = this.readStore(storage);
